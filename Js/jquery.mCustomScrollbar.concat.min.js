  ...
  var e = "mCustomScrollbar",
    ...
    b = {
      init: function (q) {
        ...
        q.scrollButtons.scrollType = g._findScrollButtonsType.call(
          null,
    ...
    g = {
      _selector: function () {
        return typeof h(this.selector) !== "object" ||
          h(this.selector).length < 1
          ? k
          : this.selector;
      },
      _theme: function (s) {
        ...
        s.autoDraggerLength =
          h.inArray(s.theme, r) > -1 ? false : s.autoDraggerLength;
        s.autoExpandScrollbar =
          h.inArray(s.theme, q) > -1 ? false : s.autoExpandScrollbar;
        s.scrollButtons.enable =
          h.inArray(s.theme, p) > -1 ? false : s.scrollButtons.enable;
        s.autoHideScrollbar =
          h.inArray(s.theme, u) > -1 ? true : s.autoHideScrollbar;
        s.scrollbarPosition =
        ...
        p.bind("mousewheel." + q, function (z, D) {
          ...
          if (t.axis === "x" || t.mouseWheel.axis === "x") {
            var w = "x",
              ...
              y =
                t.mouseWheel.scrollAmount !== "auto"
                  ? C[1]
                  : C[0] >= p.width()
                  ? p.width() * 0.9
                  : C[0],
      ...
      _draggerRail: function () {
        ...
        p.bind(
          ...
          .bind("click." + q, function (z) {
            if (
              h(z.target).hasClass("mCSB_draggerContainer") ||
              h(z.target).hasClass("mCSB_draggerRail")
            ) {
              g._stop(s);
              var w = h(this),
                ...
                if (
                  ...
                  if (A === 33 || A === 34) {
                    ...
                    if (D.type === "keyup") {
                      ...
                      if (
                        q.axis === "x" ||
                        (q.axis === "yx" && t.overflowed[1] && !t.overflowed[0])
                      ) {
                        var z = "x",
                        ...
                        if (D.type === "keyup") {
                          if (
                            ...
                            var z = "y",
                              E =
                                A === 35
                                  ? Math.abs(p.height() - w.outerHeight(false))
                                  : 0;
                          }
                          g._scrollTo(u, E.toString(), {
                            dir: z,
              ...
              if (v.indexOf("%") !== -1) {
                ...
                if (v.indexOf("-=") !== -1) {
                  ...
                  if (v.indexOf("+=") !== -1) {
                    ...
                    if (
                      v.indexOf("px") !== -1 &&
                      g._isNumeric.call(null, v.split("px")[0])
                    ) {
      ...
      _scrollTo: function (q, s, u) {
        var I = q.data(a),
          ...
          K = E.callbacks.onTotalScrollOffset
            ? g._arr.call(q, E.callbacks.onTotalScrollOffset)
            : [0, 0],
