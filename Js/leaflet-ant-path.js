!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["leaflet-ant-path"] = e(require("leaflet")))
    : (t["leaflet-ant-path"] = e(t.L));
})(window, function (t) {
  return (function (t) {
    var e = {};
    function n(r) {
    ...
    function (t, e, n) {
      ...
      if (((r.regeneratorRuntime = void 0), (t.exports = n(22)), o))
            ...
            (f.mark = function (t) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((t.__proto__ = j), c in t || (t[c] = "GeneratorFunction")),
    ...
    function (t, e, n) {
      ...
      var y = { main: Symbol("main"), pulse: Symbol("pulse") },
        v = y.main,
        d = y.pulse,
        m = Symbol.species,
          ...
          function e(t) {
            ...
            return (
              ...
              h(
                p(p(n)),
                "_reversePathClass",
                "".concat(n._animatedPathClass, "__reverse")
              ),
              ...
              h(p(p(n)), "_defaultOptions", {
                ...
                renderer: Object(r.svg)({ pane: "overlayPane" }),
                delay: 400,
                dashArray: [10, 20],
                weight: 5,
                opacity: 0.5,
            ...
            (o = [
              {
                key: "map",
                value: function (t) {
                  return new (0, this.constructor[Symbol.species])(
                    this._path.map(t),
                    c({}, this.options)
                  );
                },
              ...
              },
              {
                ...
                value: function () {
                  var t = this.options,
                    ...
                    s = c({}, t);
                  return (
                    (s.color = s.pulseColor || t.pulseColor),
                    (s.className = [
                      e,
                      o,
                      i ? n : "",
                      a ? "".concat(e, "__").concat(r) : "",
                    ].join(" ")),
                    delete u.dashArray,
                    Array.isArray(s.dashArray) &&
                      (s.dashArray = String(s.dashArray)),
                    { pathOpts: u, pulseOpts: s }
                  );
                },
              },
              {
                ...
                value: function () {
                  ...
                  t &&
                    (this.options.reverse
                      ? t.classList.remove(this._reversePathClass)
                      : t.classList.add(this._reversePathClass));
                },
              },
              {
                key: "onAdd",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    !!t.paused &&
                    ((t.paused = !1), this._calculateAnimationSpeed(), !0)
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  n ? this.pause() : this.resume(),
                    r !== this.options.delay &&
                      ((this.options.delay = r || this._defaultOptions.delay),
                      this._calculateAnimationSpeed()),
                    void 0 !== o &&
                      o !== this.options.reverse &&
                      this._pureReverse(),
                  ...
                  var i = this._processOptions(),
                    ...
                    u = i.pulseOpts;
                  return (
                    this[y.main].setStyle(a), this[y.pulse].setStyle(u), this
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  for (
                    ...
                    r[o] = arguments[o];
                  return (
                    (this._path = [].concat(u(this._path), [r])),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    (e = this[y.pulse]).spliceLatLngs.apply(e, arguments), n
                  );
                },
              },
              {
    ...
    function (t, e, n) {
      var r = n(71),
        o = Object.prototype;
      r !== o.toString && n(33)(o, "toString", r, { unsafe: !0 });
    },
    function (t, e, n) {
      "use strict";
      var r = n(72),
    ...
    function (t, e, n) {
      ...
      var r = n(0),
        ...
        V = function (t, e) {
          ...
          return (
            C(n, { type: "Symbol", tag: t, description: e }),
            i || (n.description = e),
            n
          );
        },
      ...
      H ||
        (c(
          (U = function () {
            ...
            return i && K && Q(W, e, { configurable: !0, set: n }), V(e, t);
          }).prototype,
          "toString",
          function () {
            return F(this).tag;
        ...
        u({ global: !0, wrap: !0, forced: !H, sham: !H }, { Symbol: U });
      ...
      u(
        ...
        u(
          { target: "Object", stat: !0, forced: !H, sham: !i },
          {
            create: function (t, e) {
    ...
    function (t, e, n) {
      ...
      if (
        ...
        a(l, "description", {
          ...
          n(3)({ global: !0, forced: !0 }, { Symbol: f });
      }
    },
    function (t, e, n) {
      n(6)("hasInstance");
    ...
    function (t, e, n) {
      ...
      n(3)(
        { target: "Reflect", stat: !0, forced: u, sham: !a },
        {
    ...
    function (t, e, n) {
      n(3)({ target: "Reflect", stat: !0 }, { ownKeys: n(53) });
    },
    function (t, e, n) {
      var r = n(106),
        o = n(2),
